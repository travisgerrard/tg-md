...
/***/ function(module, exports, __webpack_require__) {
	...
	var DepartmentGridTable = _react2.default.createClass({
	  displayName: "DepartmentGridTable",
	  ...
	  renderHeader: function renderHeader(label, cellDataKey) {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement("input", { type: "text", onChange: this.onFilterChange.bind(this, cellDataKey) })
	      )
	    );
	  },
	  onFilterChange: function onFilterChange(cellDataKey, event) {
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(_fixedDataTable.Column, { dataKey: "ABBREVIATION", width: 200, label: "Department Id", headerRenderer: this.renderHeader }),
	      _react2.default.createElement(_fixedDataTable.Column, { dataKey: "UPDATED", width: 200, label: "Department Id", headerRenderer: this.renderHeader }),
	      _react2.default.createElement(_fixedDataTable.Column, { dataKey: "CONTENTS", width: 200, label: "Department Name", headerRenderer: this.renderHeader })
	    );
	  }

	});

	_reactDom2.default.render(_react2.default.createElement(DepartmentGridTable, null), document.querySelector("#container"));
